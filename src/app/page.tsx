        ...
        <section className="relative mt-4 overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-orange-600/40 via-rose-900/40 to-slate-950 p-6 sm:p-10">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-3 text-xs text-white/60">
              {done} de {allLevels.length} missões concluídas · R$ {p.money} · a moto fica na calçada · o ponto azul no mapa é o arranha-céu da Dani, no centro · lojas de armas e de motos gastam o pagamento · Teclado: ← → andar, ↑ pular, F atirar, E hackeia, sobe na moto e pede ajuda no computador da torre · No celular há botões na tela
            </p>
          </div>
